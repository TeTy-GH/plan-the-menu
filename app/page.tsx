                  ...
                  <div className="relative">
                    ...
                    {isAiLoading ? (
                      ...
                      <button
                        type="button"
                        disabled
                        className="absolute top-4 right-2 px-3 py-1.5 rounded-lg text-xs font-bold bg-slate-100 text-slate-400 dark:bg-zinc-800 dark:text-zinc-500 cursor-not-allowed flex items-center gap-1 z-10"
                      >
                      ...
                      <button
                        ...
                        className="absolute top-4 right-2 px-3 py-1.5 rounded-lg text-xs font-black bg-indigo-600 text-white hover:bg-indigo-700 shadow-md shadow-indigo-500/20 animate-pulse flex items-center gap-1 z-10 transition-all duration-300"
                      >
                        <span>📌</span> メモへ貼付け
                      </button>
                    ) : (
                      ...
                      <button
                        ...
                        className="absolute top-4 right-2 px-3 py-1.5 rounded-lg text-xs font-bold bg-indigo-50 text-indigo-600 hover:bg-indigo-100 dark:bg-indigo-950/40 dark:text-indigo-400 dark:hover:bg-indigo-950/80 flex items-center gap-1 z-10 transition-colors"
                      >
                        <span>✨</span> AIレシピ作成
                      </button>
                    )}
